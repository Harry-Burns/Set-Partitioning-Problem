...
def better_mutation(p, r_min, r_max):
    N_POP = p.shape[0]
...
# --- NOT BEING USED - LEFT CODE IN TO SHOW EVIDENCE OF TESTING IT
...
def binary_genetic_algorithm(p0: np.ndarray|None=None, max_iter: int=10000, verbose=False):
    ...
    while gen < max_iter:
        ...
        p_new = better_mutation(p_new, 1, 10)
...
for f_name in ['sppnw41', 'sppnw42', 'sppnw43']:
    ...
    for x in range(TRIALS):
        ...
        best, num_gens = binary_genetic_algorithm(max_iter=MAX_ITER, verbose=True)
